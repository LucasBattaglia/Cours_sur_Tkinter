...
if __name__ == '__main__':
	...
	Bouton = tkinter.Button(fenetre, text="Bouton Normal", bg="green", activebackground="Yellow", activeforeground="blue", command=affiche_hello)
	Bouton.grid(column=0, row=1)

	Bouton_desactiver = tkinter.Button(fenetre, text="Bouton Desactiver", bg="Yellow", activebackground="Yellow", activeforeground="blue", state= tkinter.DISABLED, command=affiche_hello)
